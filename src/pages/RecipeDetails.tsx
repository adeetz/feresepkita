    ...
    <>
        ...
        >
          ...
          {recipe.photos.map((photo, index) => (
            <SwiperSlide key={photo.id}>
              <div className="relative w-full h-full flex shrink-0">
                <div
                  className="gradient-filter absolute w-full h-full bg-[linear-gradient(180deg,rgba(0,0,0,0)40.47%,#000000_81.6%)] z-10"
                />
                <img
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex shrink-0 w-[50px] h-[50px] rounded-full overflow-hidden">
              <img
                src={getImageUrl(recipe.author?.photo)}
                className="w-full h-full object-cover"
                ...
                {recipe.recipe_ingredients.map((recipeIngredients) => (
                  ...
                  >
                    <div className="thumbnail flex shrink-0 w-full aspect-[138.5/100] rounded-[20px] bg-[#D9D9D9] overflow-hidden">
                      <img
                        src={getImageUrl(recipeIngredients.ingredient?.photo)}
                        className="w-full h-full object-cover"
                        alt="thumbnails"
                      />
                    </div>
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <a
            target="_blank"
            href={getFileUrl(recipe.url_file)}
